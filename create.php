    ...
    if (empty($name_err) && empty($rank_err) && empty($salary_err) && empty($email_err)) {
        ...
        if ($stmt = mysqli_prepare($link, $sql)) {
            ...
            if (mysqli_stmt_execute($stmt)) {
                header("location: create.php?cres=Entry Successful!");
            } else {
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h4>
                        <?php if (isset($_GET['cres'])) { ?>
                            <p class="cres"> <?php echo $_GET['cres']; ?></p>
                        <?php } ?>
                    </h4>
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <select name="rank" class="form-control <?php echo (!empty($rank_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $rank; ?>">
                                <option>Vice Chancellor</option>
                                <option>Dean of the Department</option>
